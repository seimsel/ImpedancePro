...
/**
 * <pre>
 * Represents either the source or the load network.
 * </pre>
 * 
...
public class SourceLoadNetwork {
	...
	public SourceLoadNetwork(int topology,
			ElectricalComponent[] electricalComponents) {
	...
	/**
	 * <pre>
	 * Calculates the impedance of source / load components at a certain
	 * frequency.
	 * </pre>
	 * 
	 * @param f
	...
	public ComplexNumber getImpedanceAtFrequency(double f) {
		...
		ComplexNumber XR = new ComplexNumber(
				getElectricalComponents()[0].getValue(), 0);
		ComplexNumber XC = new ComplexNumber(0, -1
				/ (w * getElectricalComponents()[1].getValue()));
		ComplexNumber XL = new ComplexNumber(0, w
	...
	public void setElectricalComponents(
			ElectricalComponent[] electricalComponents) {
